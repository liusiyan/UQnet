...
# inputs
type_in = 'x_cubed_nonGaussianNoise' 	# data type to use - drunk_bow_tie x_cubed_gap ~boston
loss_type = 'qd_soft' 		# loss type to train on - qd_soft mve mse (mse=simple point prediction)
n_samples = 1000		# if generating data, how many points to generate
...
bound_limit=7. # how far to plot boundary
...
metric_names= ['PICP', 'MPIW', 'CWC', 'RMSE', 'NLL', 'shap_W', 'shap_p','R2']
