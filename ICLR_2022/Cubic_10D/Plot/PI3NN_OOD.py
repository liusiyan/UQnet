...
Nvalid = 1000
xvalid = (torch.rand(Nvalid, Npar)).to(device)
...
np.savetxt('PI3NN_nobias_MPIW_train.dat', MPIW_array_train)
np.savetxt('PI3NN_nobias_MPIW_test.dat', MPIW_array_test)
...
###------- Option I: calculate confidence score
