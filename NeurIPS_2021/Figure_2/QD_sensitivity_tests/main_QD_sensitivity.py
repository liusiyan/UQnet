...
''' 
QD hyper-parameter sensitivity analysis (s and lambda)
...
results_path = './Results/'+data_name + '_QD_sensitivity_results_seed_1_10.txt'
...
soften_list = [100., 110., 120., 130., 140., 150., 160., 170., 180., 190., 200.]
lambda_in_list = [5., 10., 15., 20., 25.]
hyper_param_list = list(itertools.product(soften_list, lambda_in_list))
...
for jjj in range(len(hyper_param_list)):
	soften = hyper_param_list[jjj][0]
	lambda_in = hyper_param_list[jjj][1]
	print('--- Experiment: {}'.format(jjj+1))
	print('--- soften: {}'.format(soften))
